    ...
    <div className={styles.container}>
      ...
      <header className={styles.header}>
        <div className={styles.headerContent}>
          <Link href="/">
            <a className={styles.logo}>EvoSim Blog</a> {/* Logo Placeholder */}
          </Link>
          <nav>
            <Link href="/">Home</Link> | <Link href="/download">Download</Link> | <Link href="/admin">Admin</Link> | <Link href="/contact">Contact</Link>
          </nav>
        </div>
        {home && (
